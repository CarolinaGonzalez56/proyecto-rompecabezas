...
function mostrarInstrucciones(instrucciones) {
    for(var i = 0; i < instrucciones.length; i++){
      mostrarInstruccionEnLista(instrucciones[i], id="lista-instrucciones");
    }
}
...
function agregarMovimiento(direccion) {
  ...
  //console.log('agregado: ' + direccion);
...
function mostrarCartelGanador() {
  Swal.fire({
    position: 'top-end',
    icon: 'success',
    title: 'Felicitaciones !! Has armado el rompecabezas.',
...
function intercambiarPosicionesGrilla(filaPos1, columnaPos1, filaPos2, columnaPos2) {
  var parte1 = grilla[filaPos1][columnaPos1];
  var parte2 = grilla[filaPos2][columnaPos2];
  //console.log(parte1 + ' ' +  parte2)
  grilla[filaPos1][columnaPos1] = parte2;
  grilla[filaPos2][columnaPos2] = parte1;

}

// Actualiza la posición de la pieza vacía [2,2]
...
function actualizarUltimoMovimiento(direccion) {
  //console.log("ejecutando la funcion actualizrUltimoMovimiento: var direccion= " + direccion)
